...
let copyright = document.querySelector(".copyright_right");
let copyrightText = `<p>©${dateNow.getFullYear()} <span>KeystoneCommerce</span>. made with <i class="ion-heart"></i>  by 
<a href="https://github.com/Zyad-Eltayabi" target="_blank">Zyad Eltayibi</a></p>`;
